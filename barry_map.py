...
map = folium.Map(location=[-36.967355, 174.918153], tiles="OpenStreetMap", zoom_start=20)
...
photo_locations = [[-36.964575, 174.908148],[-36.965038, 174.908091],[-36.965219, 174.907938],[-36.966422, 174.911517]]

descriptions = ['Bacteria', 'Bacteria', 'Trolley', 'General litter']
